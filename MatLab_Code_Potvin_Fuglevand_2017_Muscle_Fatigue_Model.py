...
fthtime=2 #ORIGINAL fthtime=100
...
np.savetxt(fileB, mufrFAT[:,:].T, delimiter=',')
np.savetxt(fileC, muPt[:,:].T, delimiter=',')
np.savetxt(fileD, muForceCapacityRel[:,:].T, delimiter=',')
